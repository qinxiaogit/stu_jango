# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-28 07:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Pubished')], max_length=1, verbose_name='状态')),
                ('abstrct', models.CharField(blank=True, help_text='可选，如若为空将摘取正文的前54个字符', max_length=50, null=True, verbose_name='摘要')),
